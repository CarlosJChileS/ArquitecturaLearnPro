...
export const useEdgeFunction = (
  ...
  }, [session, serviceName, methodName, onSuccess, onError, showSuccessToast, showErrorToast, successMessage, errorMessage, requireSession, toast]);
...
export const useGetAllUsers = (options?: UseEdgeFunctionOptions) => {
  return useEdgeFunction('admin', 'getUsers', {
    showSuccessToast: false,
    showErrorToast: true,
    ...options
  });
...
export const useGetAdminStats = (options?: UseEdgeFunctionOptions) => {
  return useEdgeFunction('admin', 'getAdminStats', {
    showSuccessToast: false,
    showErrorToast: true,
    ...options
  });
